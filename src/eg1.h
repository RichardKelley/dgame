...
void example3()
{
  ...
  float sc1[4] = {w/4,-3*w/2, 0.5*M_PI, nomv};
  float gc1[4] = {-3*w/2,w/4, -M_PI, nomv};
  float gs[4] = {0.1, 0.1, 10*M_PI/180.0, 0.1};

  float sc2[4] = {-3*w/2,-w/4, 0, nomv};
  float gc2[4] = {w/4,3*w/2, M_PI/2.0, nomv};
  ...
  float rcrr[4] = {w, -w/4, 0, 0};
  float rcrl[4] = {-w, w/4, 0, 0};
  float rclr[4] = {w, w/4, 0, 0};
  float rcll[4] = {-w, -w/4, 0, 0};

  float rsx[4] = {w, w/2, 2.0*M_PI, 2*vmax};
  float rsy[4] = {w/2, w, 2.0*M_PI, 2*vmax};

  float rssw[4] = {w,w, 2.0*M_PI, 2*vmax};
  ...
  float oclu[4] = {-w, w, 0, 0};
  float ocld[4] = {-w, -w, 0, 0};
  float os[4] = {w,w, 2.0*M_PI, 2*vmax};
