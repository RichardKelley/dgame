...
void example1()
{
  ...
  float sc1[4] = {w/2,-w/2,0, nomv};
  float gc1[4] = {-w/2,w/2, -nomv,0};
  float gs[4] = {0.2,0.2,0.1,0.1};
  
  float sc2[4] = {-w/2,-w/2, nomv,0};
  float gc2[4] = {w/2,w/2,0, nomv};
  ...
  float rcrd[4] = {w/2, -w, 0,1};
  float rcru[4] = {w/2, w, 0,1};
  float rcld[4] = {-w/2, -w, 0,-1};
  float rclu[4] = {-w/2, w, 0,-1};

  float rcrr[4] = {w, -w/2, 1,0};
  float rcrl[4] = {-w, w/2, -1,0};
  float rclr[4] = {w, w/2, -1,0};
  float rcll[4] = {-w, -w/2, 1,0};
